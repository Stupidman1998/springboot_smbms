...
$(function(){
	...
	oldpassword.on("blur",function(){
		$.ajax({
			type:"GET",
			url:path+"/pwdModify?oldpassword="+oldpassword.val(),
	...
	newpassword.on("focus",function(){
		validateTip(newpassword.next(),{"color":"#666666"},"* 密码长度必须是6~15",false);
	}).on("blur",function(){
		if(newpassword.val() != null && newpassword.val().length > 5 && newpassword.val().length < 15 ){
